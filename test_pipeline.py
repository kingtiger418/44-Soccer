...
TEST_VIDEO_URL = "https://pub-a55bd0dbae3c4afd86bd066961ab7d1e.r2.dev/2025_06_06/2025_06_06_523cd6/2025_06_06_523cd6_h2_7fbf0300c1e24dc9b8e614adef4b6b_3b74ef.mp4"
...
async def main():
    try:
        ...
        try:
            ...
            output_file = output_dir / f"result_0.json"
        ...
        try:
            ...
            destination_file = f"{Path(__file__).parent.parent.parent}/validator/tests/result_0.mp4"
            shutil.copy(source_file, destination_file)

            # video_path.unlink()

            source_file = output_file
            destination_file = f"{Path(__file__).parent.parent.parent}/validator/tests/"
            shutil.copy(source_file, destination_file)
